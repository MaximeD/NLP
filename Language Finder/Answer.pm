...
sub method_result {
  my ($method, $results) = @_ ;
  my %results = %$results ; # hash of word / suffix weights
...
sub compare {
  my ($results_words, $results_suffixes) = @_ ;
  my %results_words = %$results_words ;      # values for words
  my %results_suffixes = %$results_suffixes;   # values for suffixes
